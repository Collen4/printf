 ...
 * @buffer: buffer array to handle print
 * @flags: Calculates active flags
 * @flag_ch: Calcukates active flags
 * @width: Width
 * @precision: Precision specification.
 * @size: Size specifier.
 * Return: Number of chars printed.
...
/**
 * print_hexadecimal - Prints an unsigned number hexadecimal notation
 * @types: List of arguments.
 * @buffer: buffer array to handle print
 * @flags: Calculates active flags
 * @width: Width
...
/**
 * print_hexa_upper - Prints an unsigned number upper hexadecimal notation
 * @types: List of arguments.
 * @buffer: buffer array to handle print
 * @flags: Calculates active flags
 * @width: Width
